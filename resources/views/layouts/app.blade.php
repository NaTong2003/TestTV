...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom">
        ...
        <div class="position-absolute top-50 start-50 translate-middle">
            <span class="navbar-brand d-flex align-items-center justify-content-center">
                <i class="fas fa-ship me-2"></i>
                HỆ THỐNG ĐÁNH GIÁ NĂNG LỰC THUYỀN VIÊN
            </span>
        </div>

        {{-- Nút mobile toggle (hamburger) --}}
    ...
    <footer class="footer text-center">
        <div class="container">
            <p class="mb-0">&copy; {{ date('Y') }} Hệ thống Đánh giá Năng lực Thuyền viên. Bản quyền thuộc về VMU</p>
        </div>
    </footer>
