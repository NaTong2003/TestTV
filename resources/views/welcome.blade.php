...
<style>
    .hero-section {
        background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.6)), url('https://diemthi.tuyensinh247.com/images/simages/HHA.png');
...
<div class="hero-section">
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-lg-10">
                <h1 class="display-6 fw-bold mb-4">HỆ THỐNG ĐÁNH GIÁ NĂNG LỰC THUYỀN VIÊN</h1>
                <p class="lead mb-4">Nâng cao chất lượng đội ngũ thuyền viên thông qua hệ thống kiểm tra năng lực toàn diện, hiện đại và khách quan</p>
...
<div class="bg-light py-5">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="https://laodongcongdoan.vn/stores/news_dataimages/chinh.nguyen/082020/17/06/3850_051751-3.jpg?rt=20200817135221" width="500"
