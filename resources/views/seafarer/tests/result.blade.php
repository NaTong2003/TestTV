...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <h5 class="border-bottom pb-3">Thông tin bài kiểm tra</h5>
                            <div class="row mb-2">
                                <div class="col-sm-5">
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-5">
                                    <i class="fas fa-calendar me-2"></i> Thời gian làm bài:
                                </div>
                                <div class="col-sm-7 fw-bold">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-black">Phân tích kết quả chi tiết</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-black">Hành động tiếp theo</h6>
                </div>
                <div class="card-body">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-black">Chi tiết câu trả lời</h6>
        </div>
        <div class="card-body">
